...
const profile: string = `I am a software developer with a strong passion for Quality Assurance and aspiration to grow my career as a software developer. 
  ...
  return (
    <div className="App">
      <header className="App-header" id="home">
        ...
        <h1 style={{color: "#E6CB20"}}>ZIZI BANDA</h1>
        <h3 style={{color: "#E6CB20"}}>QA ENGINEER</h3> 
        {/* Add Socials Here */}
        <p>
          {profile}
        </p>
